...
def generate_weighted_prompt(analysis_result):
    ...
    for filename, data in analysis_result.items():
        ...
        prompt = (
            f"A person, waist up portrait, wearing {outfit}, "
            ...
            f"{background}, dramatic lighting, digital painting, vibrant, highly stylized, high quality"
        )
